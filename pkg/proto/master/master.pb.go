...
var file_pkg_proto_master_proto_rawDesc = []byte{
	...
	0x12, 0x0c, 0x0a, 0x01, 0x77, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x77, 0x32, 0xcc,
...
var file_pkg_proto_master_proto_depIdxs = []int32{
	...
	0, // 3: m_mapreduce.MasterService.CompleteTask:output_type -> m_mapreduce.Empty
	3, // 4: m_mapreduce.MasterService.Ready:output_type -> m_mapreduce.ReadyResponse
	0, // 5: m_mapreduce.MasterService.SendMinEdge:output_type -> m_mapreduce.Empty
